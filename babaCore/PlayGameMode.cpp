...
void APlayGameMode::BeginPlay()
{
...

	{
		...
		TilePtr1->setTileMap(TilePtr1->GetActorLocation().Y / TileSize, Player->GetActorLocation().X / TileSize, "00");
		TilePtr2->SetActorLocation({ TileSize * 11.5f, -TileSize * 13.5f });
		TilePtr2->setTileMap(TilePtr2->GetActorLocation().Y / TileSize, Player->GetActorLocation().X / TileSize, "00");
		TilePtr3->SetActorLocation({ TileSize * 12.5f, -TileSize * 14.5f });
		TilePtr3->setTileMap(TilePtr3->GetActorLocation().Y / TileSize, Player->GetActorLocation().X / TileSize, "00");
		TilePtr4->SetActorLocation({ TileSize * 12.5f, -TileSize * 13.5f });
		TilePtr4->setTileMap(TilePtr4->GetActorLocation().Y / TileSize, Player->GetActorLocation().X / TileSize, "00");
		TilePtr5->SetActorLocation({ TileSize * 11.5f, -TileSize * 12.5f });
		TilePtr5->setTileMap(TilePtr5->GetActorLocation().Y / TileSize, Player->GetActorLocation().X / TileSize, "00");
		TilePtr6->SetActorLocation({ TileSize * 13.5f, -TileSize * 13.5f });
		TilePtr6->setTileMap(TilePtr6->GetActorLocation().Y / TileSize, Player->GetActorLocation().X / TileSize, "00");
		TilePtr7->SetActorLocation({ TileSize * 12.5f, -TileSize * 12.5f });
		TilePtr7->setTileMap(TilePtr7->GetActorLocation().Y / TileSize, Player->GetActorLocation().X / TileSize, "00");
